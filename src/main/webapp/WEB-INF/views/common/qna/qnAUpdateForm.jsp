...
<div class="container">
	<div>
		...
		<div style="width: 70%; margin-left: 200px;">
			<form name="qnAUpdateForm" method="post" action="${pageContext.request.contextPath}/qna/update"
				onsubmit="return checkValid()">
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
				<div class="row">
					<div class="col-sm-12 ">
						<input type="hidden" name="userId" value="<sec:authentication property="principal.userId" />">
						<input type="hidden" name="qaCode" value="${requestScope.qnADTO.qaCode}">
						<div class="form-group">
							<label>게시물 제목 :</label> 
							<input type="text" name="qaTitle"
								class="form-control" placeholder="title" value="${requestScope.qnADTO.qaTitle}">
						</div>
						<div class="form-group">
							<label>게시물 내용 :</label>
							<textarea rows="6" name="qaContent" class="form-control"
								placeholder="content" style="height: 400px;">${requestScope.qnADTO.qaContent}</textarea>
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group" style="text-align: right;">
							<input type="submit" class="btn btn-primary" value="게시물수정">
